...
function export_report($report)
{
	...
	// for each of the csv users extract data from CSV report generated by SQL filter
	...
	foreach ($csv as $key => $csvuser)
		{
			...
			{
                // check to see if data exists for this already based on equality of all elements
